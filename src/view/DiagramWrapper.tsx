  ...
  const initDiagram = () => {
    ...
    diagram.nodeTemplate = $(
      go.Node,
      {
        ...
        fromLinkableSelfNode: true, // Permitir enlaces desde el mismo nodo
        toLinkableSelfNode: true,   // Permitir enlaces hacia el mismo nodo
        resizeAdornmentTemplate: $(
          ...
          $(
            go.Shape, // only a bottom resize handle
            {
              ...
              fill: "white", // Aquí puedes cambiar el color del nodo
            }
          )
        ),
      },
      ...
      $(go.Node, "Auto",
        ...
        go.GraphObject.make(go.Panel, "Auto",
          ...
          go.GraphObject.make(go.Shape, "Rectangle",
            { fill: "rgba(52, 117,80, 0.1)", stroke: "black", strokeWidth: 2 }),
