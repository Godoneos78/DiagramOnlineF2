...
const initialData = {
  nodeDataArray: [
    ...
    { group: "Objeto1", start: 1, duration: 2 },
    { group: "Objeto2", start: 2, duration: 3 },
    { group: "Objeto3", start: 3, duration: 1 },
    { group: "Objeto1", start: 5, duration: 1 },
    { group: "Objeto3", start: 6, duration: 2 },
  ],

  linkDataArray: [
    { from: "Objeto1", to: "Objeto3", text: "create()", time: 1 },
    { from: "Objeto1", to: "Objeto3", text: "searchBook(book=integer) and <<destroy>>", time: 2 },
    { from: "Objeto3", to: "Objeto1", text: "book(5)", time: 3 },
    { from: "Objeto1", to: "Objeto2", text: "takeOrder", time: 5 },
    { from: "Objeto2", to: "Objeto1", text: "serve orderReceived", time: 6 },
  ],
};
